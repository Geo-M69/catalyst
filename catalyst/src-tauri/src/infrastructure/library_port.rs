...
pub(crate) fn get_game_review(
    ...
    crate::application::services::library_review_service::get_game_review(
        state,
        provider,
        external_id,
        force_refresh,
...
pub(crate) fn list_steam_downloads(
    ...
    crate::application::services::library_downloads_service::list_steam_downloads(state)
}
...
pub(crate) fn get_game_store_metadata(
    ...
    crate::application::services::library_store_metadata_service::get_game_store_metadata(
        state,
        provider,
        external_id,
    )
